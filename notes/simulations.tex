...
\begin{definition}
  ...
  \indexdef{simulation}%
  %
  A \defemph{(pca) simulation}, originally called an \defemph{applicative morphism}~\cite{Longley:95},
...
\begin{proof}
  See \cite[Theorem 2.5.3]{Longley:95}.
\end{proof}
...
\begin{proof}
  Immediate. This is~\cite[Corollary 2.5.4]{Longley:95}.
\end{proof}
...
\begin{proof}
  This is \cite[Proposition 3.1.6]{Longley:95}.
\end{proof}
...
%
Here is one more example, an adjoint retraction from the computable graph model~$\comp{\Scott}$ and the first Kleene algebra~\cite[Proposition 3.3.7]{Longley:95}.
%
