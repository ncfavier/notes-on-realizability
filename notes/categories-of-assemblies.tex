...
$\lambda$-abstractions, a technique commonly used in functional
...
%
\begin{enumerate}
\item If $e$ is an expression of type $S$ then
  ...
  superscripts $S, T$ on $\iota_1$ and $\iota_2$.
...
\begin{proposition}
  ...
  A partitioned assembly is projective.
\end{proposition}
