...
\end{equation*}
%
the left-most occurrence of $x$ is free whereas the other two are bound
by~$\exists$.
...
\subsubsection*{Primitive recursive and recursive functions}

The \defemph{primitive recursive functions} are those functions $\NN^k \to
